  ...
  return (
    <div className='footer-grid'>
      ...
      <MultiColumn columns={2}>
        ...
        <p><a className='link' href="Pricing">Pricing</a></p>
        <p><a className='link' href="Products">Products</a></p>
        <p><a className='link' href="About">About Us</a></p>
        <p><a className='link' href="Careers">Careers</a></p>
        <p><a className='link' href="Community">Community</a></p>
        <p><a className='link' href="Privacy">Privacy Policy</a></p>
      </MultiColumn>
      <SocialMedias />
